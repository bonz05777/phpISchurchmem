...
<body>
                ...
                <div class="modal-body">
                    <div class="list-group">
                        <a href="#" class="list-group-item list-group-item-action" id="transferLink">Transfer
                            Request</a>
                        <a href="#" class="list-group-item list-group-item-action" id="baptismLink">Baptism Certificate
                            Request</a>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#selectTransactionModal">
        Make Transaction
    </button>
    ...
    <div id="requestTransfer" style="display:none">
        <form>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="transaction-churchname-transfer"
    ...
    <div class="modal fade" id="purposeLetterModal" tabindex="-1" role="dialog"
        aria-labelledby="purposeLetterModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
