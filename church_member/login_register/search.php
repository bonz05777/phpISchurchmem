                ...
                <div class="modal-content">
                    ...
                    <form id="baptismCertificateForm" onsubmit="saveTransactionDetails(event)" class="p-3">
                        <div class="form-group"> <label for="bfname">First Name:</label>
                            <input type="text" id="bfname" name="bfname" class="form-control capitalize-words" required
                                style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="blname" name="blname" class="form-control capitalize-words" required
                                style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                            <label for="bchurchname">Church Name:</label>
                            <input type="text" id="bchurchname" name="bchurchname" class="form-control capitalize-words"
                                required style="text-transform: capitalize;">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="excuseLetterForm" onsubmit="saveTransactionDetails(event)" class="p-3">
                        <div class="form-group"> <label for="efname">First Name:</label>
                            ...
                            <input type="text" id="efname" name="efname" class="form-control capitalize-words" required
                                style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="elname" name="elname" class="form-control capitalize-words" required
                                style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                            <label for="echurchname">Church Name:</label>
                            <input type="text" id="echurchname" name="echurchname" class="form-control capitalize-words"
                                required style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <form id="purposeLetterForm" onsubmit="saveTransactionDetails(event)" class="p-3">
                        <div class="form-group"> <label for="pfname">First Name:</label>
                            <input type="text" id="pfname" name="pfname" class="form-control capitalize-words" required
                                style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="plname" name="plname" class="form-control capitalize-words" required
                                style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
                            <label for="pchurchname">Church Name:</label>
                            <input type="text" id="pchurchname" name="pchurchname" class="form-control capitalize-words"
                                required style="text-transform: capitalize;">
                        </div>
                        <div class="form-group">
            ...
            function saveTransactionDetails(event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Create a modal element with the success message
