        ...
        <div class="box form-box">
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($result['username'] == $username && $result['email'] == $email && $result['churchname'] == $churchname) {
                    echo "<script>alert('No changes have been made.'); window.location.href='userinterface.php';</script>";
                    ...
                    if ($edit_query) {
                        echo "<script>alert('Profile updated successfully.'); window.location.href='userinterface.php';</script>";
                    }
                }
            } else {
                $id = $_SESSION['id'];
