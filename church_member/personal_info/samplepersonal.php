...
if (isset($_GET['search'])) {
    ...
    echo '<script>document.getElementById("searchID").reset();</script>';
        ...
        <?php } else { ?>
            <table border="1" cellpadding="0">
                <tr>
                    ...
                    <th>
                        <a href="?sort=civilstatus&order=<?= $sort == 'civilstatus' && $order == 'asc' ? 'desc' : 'asc' ?>">Civil
                            Status</a>
                    </th>
                    <th>
                        <a href="?sort=addressID&order=<?= $sort == 'addressID' && $order == 'asc' ? 'desc' : 'asc' ?>">Address
                            ID</a>
                    </th>
                    <th>
                        <a
                            href="?sort=birthdate&order=<?= $sort == 'birthdate' && $order == 'asc' ? 'desc' : 'asc' ?>">Birthdate</a>
                    </th>
                    <th>
                        <a
                            href="?sort=birthplace&order=<?= $sort == 'birthplace' && $order == 'asc' ? 'desc' : 'asc' ?>">Birthplace</a>
                    </th>
                    <th>
                        <a href="?sort=father&order=<?= $sort == 'father' && $order == 'asc' ? 'desc' : 'asc' ?>">Father</a>
                    </th>
                    <th>
                        <a href="?sort=mother&order=<?= $sort == 'mother' && $order == 'asc' ? 'desc' : 'asc' ?>">Mother</a>
                    </th>
                    <th>
                        <a href="?sort=educlevel&order=<?= $sort == 'educlevel' && $order == 'asc' ? 'desc' : 'asc' ?>">Education
                            Level</a>
                    </th>
                    <th>
                        <a
                            href="?sort=contactnumber&order=<?= $sort == 'contactnumber' && $order == 'asc' ? 'desc' : 'asc' ?>">Contact
                            Number</a>
                    </th>
                    <th>Operation</th>
                </tr>
